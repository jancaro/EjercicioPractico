...
public class ApiReport {
    ...
    public ResponseEntity<String> getMovements(@PathVariable("clientId") String clientId, @PathVariable("from") Long from, @PathVariable("to") Long to) throws DocumentException {
